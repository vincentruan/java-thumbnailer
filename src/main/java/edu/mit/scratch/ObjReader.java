...
public class ObjReader {
    ...
    public ObjReader(InputStream var1) {
        this.s = new DataInputStream(var1);
    }

    public Object[][] readObjects(LContext var1) throws IOException {
        this.readInfo();
        this.readObjTable(var1);
        return this.objTable;
    }

    public Hashtable readInfo() throws IOException {
    ...
    public void readObjTable(LContext var1) throws IOException {
    ...
    public Object readField() throws IOException {
    ...
    public Object readFixedFormat(int var1) throws IOException {
        int var2;
        byte[] var5;
        Object[] var6;
        int var12;
    ...
    public void createSpritesAndWatchers(LContext var1) {
    ...
    public void buildImagesAndSounds() throws IOException {
        for (int var1 = 0; var1 < this.objTable.length; ++var1) {
            int var2 = ((Number) this.objTable[var1][1]).intValue();
            Object[] var3;
            if (var2 == 34 || var2 == 35) {
